...
export const addBar = (beatCount: number, dibobinador: number, tempo: number) =>
  useEditorStore.setState(state => {
    ...
    SheetModule.addBarToSheet(state.currentSheet, beatCount, dibobinador, tempo);
...
export const addNote = (duration: number, pitchName: PitchName, octave: Octave) =>
  useEditorStore.setState(state => {
    ...
    SheetModule.addNoteToSheet(state.currentSheet, state.cursor.trackIndex, noteToAdd);
    SheetModule.fillBarTracksInSheet(state.currentSheet, state.cursor.trackIndex);
...
export const removeNoteFromBar = (noteToRemove: Note) =>
  useEditorStore.setState(state => {
    ...
    SheetModule.removeNotesFromSheet(state.currentSheet, state.cursor.trackIndex, [noteToRemove]);
    SheetModule.fillBarTracksInSheet(state.currentSheet, state.cursor.trackIndex);
