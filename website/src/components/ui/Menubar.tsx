...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-8 items-center space-x-1 border-b bg-background",
      className,
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-accent-foreground data-[disabled]:opacity-50",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(
  (
    { className, align = "start", alignOffset = -4, sideOffset = 2, ...props },
    ref,
  ) => (
